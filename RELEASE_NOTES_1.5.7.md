# Release Notes — v1.5.7 (2026-06-15)

## 📋 Executive Summary

Version 1.5.7 addresses **three critical bugs** discovered and fixed during this session:
...
| `CHANGELOG.md` | Top | Added v1.5.7 release notes |
| `README.md` | Recent Updates section | Added v1.5.7 entry |
| `DOCUMENTATION.md` | Top of file | Added Latest Update section |
| `package.json` | — | Version bumped 1.5.6 → 1.5.7 |
...
## 📁 Complete File Change List (v1.5.7)
...
| `CHANGELOG.md` | Documentation | Added v1.5.7 release notes with full details |
| `README.md` | Documentation | Updated "Recent Updates" section with v1.5.7 entry |
| `DOCUMENTATION.md` | Documentation | Added Latest Update section documenting all fixes |
| `package.json` | Version Bump | 1.5.6 → 1.5.7 |
...
- [x] CHANGELOG.md updated with v1.5.7 entry
...
```
fix: text_transform combined flags + web content OOM prevention (v1.5.7)
...
Documentation:
- Updated CHANGELOG.md with v1.5.7 release notes
- Updated README.md Recent Updates section
- Updated DOCUMENTATION.md Latest Update section
- Created RELEASE_NOTES_1.5.7.md (this file)
