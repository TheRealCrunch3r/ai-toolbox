...
**analyze_project(categories?, max_imports_warning?)** — Comprehensive TypeScript performance & linting analysis
...
- Fallback: DDG Fetch → DDG API → DDG browser → Google → Bing
